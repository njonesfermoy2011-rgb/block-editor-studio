...
function bes_enqueue_editor_assets() {
	...
	wp_enqueue_script(
		...
		array( 'wp-plugins', 'wp-editor', 'wp-edit-post', 'wp-element', 'wp-i18n', 'wp-data', 'wp-blocks', 'wp-notices', 'wp-rich-text', 'wp-block-editor', 'wp-word-count', 'wp-components', 'heartbeat' ),
		BES_VERSION,
		true
	);
